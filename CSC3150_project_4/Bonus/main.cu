...
#define FCB_SIZE 38 //38 bytes per FCB
#define FCB_ENTRIES 1024
#define VOLUME_SIZE 1091584 //4096+38*1024+1048576
...
#define FILE_BASE_ADDRESS 43008 //4096+38*1024

// time counter
__device__ __managed__ u32 timer = 0;

// current directory information
__device__ __managed__ u32 directory = 0;
...
__global__ void mykernel(uchar *input, uchar *output) {
  ...
  fs_init(&fs, volume, SUPERBLOCK_SIZE, FCB_SIZE, FCB_ENTRIES, 
			...
			MAX_FILE_NUM, MAX_FILE_SIZE, FILE_BASE_ADDRESS, &timer, &directory);
